...
if (isset($_POST["Enviar"])) {
    $formulari = 0;
    $NIF = $_POST["NIF"];
    $sql = "SELECT Localitat, Nom, Adreca, Telefon, Correu FROM empresa WHERE NIF = '$NIF'";
...
if(isset($_POST["Actualitzar"])){
    ...
    $sql = "UPDATE empresa SET Localitat = '$Valornou1', Nom = '$Valornou2', Adreca = '$Valornou3', Telefon = '$Valornou4', Correu = '$Valornou5' WHERE NIF = '$NIF'";
...
if ($formulari==1){ 
?>
    <h2>Posa el NIF de l'empresa</h2>
    <form method="POST" action="<?php echo $_SERVER["PHP_SELF"]; ?>">
